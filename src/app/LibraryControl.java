...
public class LibraryControl{
	...
	//Glowna petla programu - wybor opcji i interakcja
	...
	public void controlLoop(){
		...
		while (option != Option.EXIT){
			try{
				...
				System.out.println("Wprowadzono niepoprawne dane - nie dodano publikacji");
			}catch(NumberFormatException | NoSuchElementException e){
				System.out.println("Wybrana opcja ie istnieje - wybierz jeszcze raz: ");
			}
		}
    ...
    private enum Option {
    	...
    	PRINT_MAGAZINES(4, "Wyswietlenie dostepnych magazynow");
